			...
			<div class="center-container">
				...
				<div class="components-container">
					<div class="form-components">
						<form action="../INC/payment_ctrls_inc.php" method="post">
						
							<?php 
					
								require '../INC/payment_on_load_inc.php';
							...
							if(isset($_GET['error'])){
								...
								} elseif ($_GET['error'] == 'onlyAplhabet') {
									echo '<p class="error-para">The card name can only be letters!!</p>';
								} elseif ($_GET['error'] == 'onlyDigits1') {
									echo '<p class="error-para">The card code can only be numeric!!</p>';
								} elseif ($_GET['error'] == 'onlyDigits2') {
									echo '<p class="error-para">The card number can only be numeric!!</p>';
								} elseif ($_GET['error'] == 'onlyDigits3') {
									echo '<p class="error-para">The card expiry year value can only be numeric!!</p>';
								} elseif ($_GET['error'] == 'onlyDigits4') {
									echo '<p class="error-para">The card expiry year value can only be numeric!!</p>';
