...
public class Setting_Admin extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ToggleButton tb1 = (ToggleButton)findViewById(R.id.admin_toggle);
    ...
    public void onDelete(View view) {
        ...
        confirm.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                update_values.put("Active", 0);
                oper.updateData(employeeDetailsTable, update_values, "Employee_ID = ?", new String[]{getUserCode()});
